...
function Login() {
    ...
    return <>
        <div className="flex flex-col justify-center h-screen w-full">
            <form className="bg-gray-900 py-4 px-4 md:px-12 sm:px-8 text-white w-11/12 rounded shadow-lg max-w-[500px] mx-auto" onSubmit={handleSubmit}>
                ...
                <Input label="Password" placeholder="Enter your Password" name="password" onChange={handleChange} value={inputs.password} />
